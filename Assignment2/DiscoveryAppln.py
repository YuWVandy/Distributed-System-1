...
def parseCmdLineArgs():
    ...
    parser.add_argument("-num_pub", "--num_pub", type=int, default=20,
                        help="Number of publisher")

    parser.add_argument("-num_sub", "--num_sub", type=int, default=20,
                        help="Number of subscriber")

    parser.add_argument("-num_disc", "--num_disc", type=int, default=20,
                        help="Number of discovery in total")
