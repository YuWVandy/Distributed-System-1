...
class PublisherMW ():
  ...
  def register (self, name, topiclist):
    ...
    try:
      ...
      self.logger.info ("PublisherMW::register - sent register message and now wait for reply")
  ...
  def is_ready (self):
    ...
    try:
      ...
      isready_req.num_pub = 0 #when either pub or sub ask discovery is ready, the total_count starts from 0
      isready_req.num_sub = 0
