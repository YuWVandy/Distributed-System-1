...
class BrokerAppln ():
    ...
    def configure(self, args):
        ...
        try:
            ...
            self.lookup = config["Broker"]["Strategy"]
    ...
    def invoke_operation(self):
        ...
        try:
            ...
            if (self.state == self.State.REGISTER):
                ...
                self.logger.debug(
                    "BrokerAppln::invoke_operation - register with the discovery service")
                ...
                self.logger.debug(
                    "BrokerAppln::invoke_operation - check if are ready to go")
                ...
                self.logger.debug(
                    "BrokerAppln::invoke_operation - start getting transfer information from pub to sub")

                # print(111, self.topiclist)
                self.mw_obj.transfer()

                self.logger.debug(
                    "BrokerAppln::invoke_operation - transfer completed")
    ...
    def register_response(self, reg_resp):
        ...
        try:
            ...
            if (reg_resp.status == discovery_pb2.STATUS_SUCCESS):
                self.logger.debug(
                    "BrokerAppln::register_response - registration is a success")
                ...
                self.logger.debug(
                    "BrokerAppln::register_response - registration is a failure with reason {}".format(response.reason))
    ...
    def isready_response(self, isready_resp):
        ...
        try:
            ...
            if not isready_resp.status:
                ...
                self.logger.debug(
                    "BrokerAppln::driver - Not ready yet; check again")
                self.logger.info(
                    "BrokerAppln::driver - Not ready yet; check again")
                ...
                self.logger.info(
                    "BrokerAppln::driver - System ready; let's transfer from pub to sub!!")
                print(444)
    ...
    def connect_publisher(self, lookup_resp):
        ...
        try:
            self.logger.info(
                "BrokerAppln::try to connect to matched publisher")
...
def parseCmdLineArgs():
    ...
    parser.add_argument ("-b_sub", "--b_sub", default=6555)

    parser.add_argument ("-b_pub", "--b_pub", default=7555)
