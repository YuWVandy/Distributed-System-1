...
_MSGTYPES = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TYPE_RESP_LOOKUP_PUB_BY_TOPIC', index=5, number=5,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
...
TYPE_RESP_LOOKUP_PUB_BY_TOPIC = 5
...
_LOOKUPPUBBYTOPICRESP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='addr', full_name='LookupPubByTopicResp.addr', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='port', full_name='LookupPubByTopicResp.port', index=1,
