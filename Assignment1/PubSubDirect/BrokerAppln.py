    ...
    def invoke_operation(self):
        ...
        try:
            ...
            if (self.state == self.State.REGISTER):
                ...
                self.logger.debug(
                    "Appln::invoke_operation - check if are ready to go")
                ...
                self.logger.debug(
                    "BrokerAppln::invoke_operation - start getting publisher information")
    ...
    def isready_response(self, isready_resp):
        ...
        try:
            ...
            if not isready_resp.status:
                ...
                self.logger.info(
                    "BrokerAppln::driver - System ready; let's connect to discovery for getting publisher information!!")
